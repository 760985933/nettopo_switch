...
profile: {
  ...
  addTitle: 'Nouvelle config de connexion',
  confirmAdd: 'Ajouter',
  cancelAdd: 'Annuler',
  namePlaceholder: 'Nom de la config (ex. OpenAI, Azure)',
  providerPlaceholder: 'Sélectionner le fournisseur',
  switched: 'Basculé vers : {name}',
  switchedWithRestart: 'Basculé et proxy redémarré : {name}',
  added: 'Config ajoutée : {name}',
  deleted: 'Config supprimée : {name}',
  current: 'Actuel',
  delete: 'Supprimer la config',
  confirmDelete: 'Supprimer la config "{name}" ?',
