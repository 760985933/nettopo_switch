...
profile: {
  ...
  addTitle: 'Nueva configuración de conexión',
  confirmAdd: 'Agregar',
  cancelAdd: 'Cancelar',
  namePlaceholder: 'Nombre de la configuración (ej. OpenAI, Azure)',
  providerPlaceholder: 'Seleccionar proveedor',
  switched: 'Cambiado a: {name}',
  switchedWithRestart: 'Cambiado y proxy reiniciado: {name}',
  added: 'Configuración agregada: {name}',
  deleted: 'Configuración eliminada: {name}',
  current: 'Actual',
  delete: 'Eliminar configuración',
  confirmDelete: '¿Eliminar configuración "{name}"?',
